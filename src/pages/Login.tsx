...
// FIX: Changing the explicit file extension from .ts to .js to resolve the module path error
...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // If successful, Supabase handles the browser redirection.
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          >
            {/* Simple Google SVG Icon (Full Path) */}
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <button
                type="button" // Ensuring this button does not submit the form
